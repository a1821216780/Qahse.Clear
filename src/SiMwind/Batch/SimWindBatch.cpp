...
// ───────────────────────────────── File Info ─────────────────────────────────
//
// 该文件实现了 SimWindBatch 批量处理引擎，解析 CSV/Excel 输入文件生成参数组合，
// 并在多线程中并行运行 SimWind 以批量生成风场。
//
// ──────────────────────────────────────────────────────────────────────────────
...
struct BatchContext
{
	...
	SimWindBatchProgressCallback progress;
	std::string templateExt = ".qwd";   ///< 模板文件扩展名，用于派生文件命名
};

using OverrideApplier = std::function<void(SimWindInput &, const std::string &)>;
...
/** @brief 返回覆盖键到应用函数的映射表，支持对SimWindInput各参数字段通过字符串键进行批量覆盖设置。 */
const std::unordered_map<std::string, OverrideApplier> &OverrideAppliers()
{
	static const std::unordered_map<std::string, OverrideApplier> appliers{
	    {"TurbModel", [](SimWindInput &in, const std::string &v) { SetEnum(in.turbModel, v); }},
	    {"WindModel", [](SimWindInput &in, const std::string &v) { SetEnum(in.windModel, v); }},
	    {"CalWu", [](SimWindInput &in, const std::string &v) { in.calWu = ParseBoolStrict(v); }},
	    {"CalWv", [](SimWindInput &in, const std::string &v) { in.calWv = ParseBoolStrict(v); }},
	    {"CalWw", [](SimWindInput &in, const std::string &v) { in.calWw = ParseBoolStrict(v); }},
	    {"WrBlwnd", [](SimWindInput &in, const std::string &v) { in.wrBlwnd = ParseBoolStrict(v); }},
	    {"WrTrbts", [](SimWindInput &in, const std::string &v) { in.wrTrbts = ParseBoolStrict(v); }},
	    {"WrTrwnd", [](SimWindInput &in, const std::string &v) { in.wrTrwnd = ParseBoolStrict(v); }},
	    {"IECStandard", [](SimWindInput &in, const std::string &v) { SetEnum(in.iecEdition, v); }},
	    {"IECClass", [](SimWindInput &in, const std::string &v) { SetEnum(in.turbineClass, v); }},
	    {"TurbulenceClass", [](SimWindInput &in, const std::string &v) { SetEnum(in.turbClass, v); }},
	    {"VRef", [](SimWindInput &in, const std::string &v) { SetNumber(in.vRef, v); }},
	    {"RotorDiameter", [](SimWindInput &in, const std::string &v) { SetNumber(in.rotorDiameter, v); }},
	    {"MeanWindSpeed", [](SimWindInput &in, const std::string &v) { SetNumber(in.meanWindSpeed, v); }},
	    {"HubHt", [](SimWindInput &in, const std::string &v) { SetNumber(in.hubHeight, v); }},
	    {"RefHt", [](SimWindInput &in, const std::string &v) { SetNumber(in.refHeight, v); }},
	    {"ShearType", [](SimWindInput &in, const std::string &v) { SetEnum(in.shearType, v); }},
	    {"WindProfileType", [](SimWindInput &in, const std::string &v) { SetEnum(in.windProfileType, v); }},
	    {"PLExp", [](SimWindInput &in, const std::string &v) { SetNumber(in.shearExp, v); }},
	    {"Z0", [](SimWindInput &in, const std::string &v) { SetNumber(in.roughness, v); }},
	    {"Roughness", [](SimWindInput &in, const std::string &v) { SetNumber(in.roughness, v); }},
	    {"HFlowAng", [](SimWindInput &in, const std::string &v) { SetNumber(in.horAngle, v); }},
	    {"VFlowAng", [](SimWindInput &in, const std::string &v) { SetNumber(in.vertAngle, v); }},
	    {"UserShearFile", [](SimWindInput &in, const std::string &v) { SetText(in.userShearFile, v); }},
	    {"TurbIntensity", [](SimWindInput &in, const std::string &v) { SetNumber(in.turbIntensity, v); }},
	    {"RandSeed", [](SimWindInput &in, const std::string &v) { SetNumber(in.turbSeed, v); }},
	    {"NumPointY", [](SimWindInput &in, const std::string &v) { SetNumber(in.gridPtsY, v); }},
	    {"NumPointZ", [](SimWindInput &in, const std::string &v) { SetNumber(in.gridPtsZ, v); }},
	    {"LenWidthY", [](SimWindInput &in, const std::string &v) { SetNumber(in.fieldDimY, v); }},
	    {"LenHeightZ", [](SimWindInput &in, const std::string &v) { SetNumber(in.fieldDimZ, v); }},
	    {"WindDuration", [](SimWindInput &in, const std::string &v) { SetNumber(in.simTime, v); }},
	    {"TimeStep", [](SimWindInput &in, const std::string &v) { SetNumber(in.timeStep, v); }},
	    {"UserTurbFile", [](SimWindInput &in, const std::string &v) { SetText(in.userTurbFile, v); }},
	    {"UseIECSimmga", [](SimWindInput &in, const std::string &v) { in.useIECSimmga = ParseBoolStrict(v); }},
	    {"ScaleIEC", [](SimWindInput &in, const std::string &v) { SetNumber(in.scaleIEC, v); }},
	    {"ETMc", [](SimWindInput &in, const std::string &v) { SetNumber(in.etmC, v); }},
	    {"AnalysisTime", [](SimWindInput &in, const std::string &v) { SetNumber(in.analysisTime, v); }},
	    {"Rich_No", [](SimWindInput &in, const std::string &v) { SetNumber(in.richardson, v); }},
	    {"UStar", [](SimWindInput &in, const std::string &v) { SetNumber(in.uStar, v); }},
	    {"ZL", [](SimWindInput &in, const std::string &v) { SetNumber(in.zOverL, v); }},
	    {"ZI", [](SimWindInput &in, const std::string &v) { SetNumber(in.mixingLayerDepth, v); }},
	    {"PC_UW", [](SimWindInput &in, const std::string &v) { SetNumber(in.reynoldsUW, v); }},
	    {"PC_UV", [](SimWindInput &in, const std::string &v) { SetNumber(in.reynoldsUV, v); }},
	    {"PC_VW", [](SimWindInput &in, const std::string &v) { SetNumber(in.reynoldsVW, v); }},
	    {"VxLu", [](SimWindInput &in, const std::string &v) { SetNumber(in.vkLu, v); }},
	    {"VxLv", [](SimWindInput &in, const std::string &v) { SetNumber(in.vkLv, v); }},
	    {"VxLw", [](SimWindInput &in, const std::string &v) { SetNumber(in.vkLw, v); }},
	    {"VyLu", [](SimWindInput &in, const std::string &v) { SetNumber(in.vyLu, v); }},
	    {"VyLv", [](SimWindInput &in, const std::string &v) { SetNumber(in.vyLv, v); }},
	    {"VyLw", [](SimWindInput &in, const std::string &v) { SetNumber(in.vyLw, v); }},
	    {"VzLu", [](SimWindInput &in, const std::string &v) { SetNumber(in.vzLu, v); }},
	    {"VzLv", [](SimWindInput &in, const std::string &v) { SetNumber(in.vzLv, v); }},
	    {"VzLw", [](SimWindInput &in, const std::string &v) { SetNumber(in.vzLw, v); }},
	    {"Latitude", [](SimWindInput &in, const std::string &v) { SetNumber(in.latitude, v); }},
	    {"TI_u", [](SimWindInput &in, const std::string &v) { SetNumber(in.tiU, v); }},
	    {"TI_v", [](SimWindInput &in, const std::string &v) { SetNumber(in.tiV, v); }},
	    {"TI_w", [](SimWindInput &in, const std::string &v) { SetNumber(in.tiW, v); }},
	    {"MannAlphaEps", [](SimWindInput &in, const std::string &v) { SetNumber(in.mannAlphaEps, v); }},
	    {"MannScalelength", [](SimWindInput &in, const std::string &v) { SetNumber(in.mannLength, v); }},
	    {"MannGamma", [](SimWindInput &in, const std::string &v) { SetNumber(in.mannGamma, v); }},
	    {"MannMaxL", [](SimWindInput &in, const std::string &v) { SetNumber(in.mannMaxL, v); }},
	    {"MannNx", [](SimWindInput &in, const std::string &v) { SetNumber(in.mannNx, v); }},
	    {"MannNy", [](SimWindInput &in, const std::string &v) { SetNumber(in.mannNy, v); }},
	    {"MannNz", [](SimWindInput &in, const std::string &v) { SetNumber(in.mannNz, v); }},
	    {"CohMod1", [](SimWindInput &in, const std::string &v) { in.cohMod1 = simwind_io_detail::ParseCohModel(v, in.cohMod1); }},
	    {"CohMod2", [](SimWindInput &in, const std::string &v) { in.cohMod2 = simwind_io_detail::ParseCohModel(v, in.cohMod2); }},
	    {"CohMod3", [](SimWindInput &in, const std::string &v) { in.cohMod3 = simwind_io_detail::ParseCohModel(v, in.cohMod3); }},
	    {"CohDecayU", [](SimWindInput &in, const std::string &v) { SetNumber(in.cohDecayU, v); }},
	    {"CohDecayV", [](SimWindInput &in, const std::string &v) { SetNumber(in.cohDecayV, v); }},
	    {"CohDecayW", [](SimWindInput &in, const std::string &v) { SetNumber(in.cohDecayW, v); }},
	    {"CohScaleB", [](SimWindInput &in, const std::string &v) { SetNumber(in.cohScaleB, v); }},
	    {"CohExp", [](SimWindInput &in, const std::string &v) { SetNumber(in.cohExp, v); }},
	    {"AllowCohApprox", [](SimWindInput &in, const std::string &v) { in.allowCohApprox = ParseBoolStrict(v); }},
	    {"EWMType", [](SimWindInput &in, const std::string &v) { SetEnum(in.ewmType, v); }},
	    {"GustPeriod", [](SimWindInput &in, const std::string &v) { SetNumber(in.gustPeriod, v); }},
	    {"EventStart", [](SimWindInput &in, const std::string &v) { SetNumber(in.eventStart, v); }},
	    {"EventSign", [](SimWindInput &in, const std::string &v) { SetEnum(in.eventSign, v); }},
	    {"EcdVcog", [](SimWindInput &in, const std::string &v) { SetNumber(in.ecdVcog, v); }},
	    {"WrWndName", [](SimWindInput &in, const std::string &v) { SetText(in.saveName, v); }},
	    {"SumPrint", [](SimWindInput &in, const std::string &v) { in.sumPrint = ParseBoolStrict(v); }}};
	return appliers;
}
...
/**
 * @brief 从SimWindInput指定的Excel工作簿中读取批处理案例定义。
 *
 * 读取指定工作表的列头（CaseName/Enabled/OutputSubdir及Override.Meta.*列），
 * 逐行解析每个案例的配置信息和覆盖参数，构建BatchWorkbook结构返回。
 *
 * @param input 包含batchExcelPath和batchSheetName的SimWindInput配置
 ...
 *       重复CaseName抛出异常。
 * @code
 *   SimWindInput input = ReadSimWindInput("template.qwd");
 *   BatchWorkbook workbook = ReadBatchWorkbook(input);
 *   for (const auto &spec : workbook.cases)
 *       std::cout << spec.caseName << "\n";
 * @endcode
 */
BatchWorkbook ReadBatchWorkbook(const SimWindInput &input)
{
...
/**
 * @brief 基于基础输入和案例覆盖规范生成派生SimWindInput。
 *
 * 复制基础输入，清除批处理相关字段，将mode设为GENERATE，然后逐一应用案例特定的覆盖参数。
 *
 * @param base 基础SimWindInput配置模板
 * @param spec 包含覆盖键值对的BatchCaseSpec案例规范
 * @return 应用覆盖后的派生SimWindInput，mode已设置为GENERATE
 * @note 覆盖键通过OverrideAppliers()映射表查找对应应用函数；不支持的覆盖键将抛出异常。
 * @code
 *   SimWindInput derived = ApplyOverrides(baseInput, caseSpec);
 *   WriteSimWindInput(derived, "case_output.qwd");
 * @endcode
 */
SimWindInput ApplyOverrides(const SimWindInput &base, const BatchCaseSpec &spec)
{
	SimWindInput derived = base;
 ...
 * @endcode
 */
void WriteBatchManifest(const SimWindBatchResult &result)
{
 ...
 * @endcode
 */
void WriteBatchCsv(const SimWindBatchResult &result)
{
 ...
 * @endcode
 */
void WriteBatchSummary(const SimWindBatchResult &result, bool validateOnly)
{
	std::ofstream out(result.summaryPath, std::ios::binary);
	out << "SimWind batch " << (validateOnly ? "validation" : "generation") << " summary\n";
 ...
 * @return SimWindBatchCaseResult 包含执行状态、耗时、输出路径等完整结果
 ...
 *   SimWindBatchCaseResult result = ExecuteSingleCase(ctx, spec);
 * @endcode
 */
SimWindBatchCaseResult ExecuteSingleCase(const BatchContext &ctx, const BatchCaseSpec &spec)
{
	SimWindBatchCaseResult result;
	...
	try
	{
		...
		WriteSimWindInput(derived, result.derivedQwdPath);
...
void TallyResult(const SimWindBatchCaseResult &item, SimWindBatchResult &result)
{
                                         ...
                                         SimWindBatchProgressCallback progress)
{
	...
	if (ctx.templateExt.empty())
		ctx.templateExt = ".qwd";
	ctx.input = ReadSimWindInput(qwdPath);
	...
	for (const auto &item : workbook.cases)
	{
		if (!item.enabled)
		{
			SimWindBatchCaseResult skipped;
