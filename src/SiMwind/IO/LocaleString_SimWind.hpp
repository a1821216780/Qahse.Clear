...
// ───────────────────────────────── File Info ─────────────────────────────────
//
// 该文件定义了 SimWind 模块专用的双语异常、警告和进度消息字符串。
//
// ──────────────────────────────────────────────────────────────────────────────
...
// ============================================================================
// SimWindBatch — Parse error strings
// ============================================================================
...
#define L_BATCH_RequiresModeBatch        TL("SimWind 批处理运行器要求输入 .qwd 中 Mode=BATCH", "SimWind batch runner requires Mode=BATCH in the input .qwd")

// ============================================================================
// SimWindBatch — Progress strings
// ============================================================================
...
// ============================================================================
// SimWindBatch — Summary output strings
// ============================================================================

#define L_BATCH_SummaryValidation   TL("SimWind 批处理验证摘要", "SimWind batch validation summary")
#define L_BATCH_SummaryGeneration    TL("SimWind 批处理生成摘要", "SimWind batch generation summary")
...
// ============================================================================
// SimWindBatch — Status / result strings (used as JSON/CSV field values)
// ============================================================================
...
// ============================================================================
// SimWindBatch — Case result message strings
// ============================================================================
...
#define L_CASE_RunningInproc             TL("正在运行进程内 SimWind 批处理案例", "Running in-process SimWind batch case")
#define L_CASE_RunningSubprocess         TL("正在运行子进程 SimWind 批处理案例", "Running subprocess SimWind batch case")
