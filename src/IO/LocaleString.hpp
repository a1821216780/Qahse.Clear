...
#define L_CLI_OptionQWD           TL("  --qwd <文件>           使用 SimWind .qwd 文件", "  --qwd <file>           Run a SimWind .qwd file")
...
#define L_CLI_RunningSimWind      TL(" 正在运行 SimWind，输入文件 \"", " Running SimWind with input file \"")
...
#define L_CLI_RunningBatch        TL(" 正在运行 SimWind 批量模式...", " Running SimWind batch mode...")
...
#define L_CLI_BatchRunnerFailed   TL("SimWind 批量运行失败: ", "SimWind batch runner failed: ")
#define L_CLI_RunningImport       TL(" 正在运行 WindL 读取，文件 \"", " Running WindL import with file \"")
