...
struct WindField
{
	 ...
	 */
	static WindField ReadBladedWnd(const std::string &path, const WindLInput &input);
	 ...
	 */
	static WindField ReadAny(const std::string &path, WndFormat format, const WindLInput &input);
};
