#!/usr/bin/env python3
"""Validate and visualise SimWind SimWind output across DEMO and IEC61400-3 cases.
...
def parse_sum_file(path: Path) -> dict:
    """Extract statistics and parameters from a SimWind .sum text file."""
...
def generate_report(cases: list[dict], main_sum: dict | None, outdir: Path) -> str:
    ...
    lines.append("# SimWind Simulation Validation Report\n")
    ...
    if failed == 0 and warned == 0:
        lines.append(
            ...
            "The SimWind SimWind generator produces consistent output across turbulence "
