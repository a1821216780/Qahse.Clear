"""Convert SimWind .qwd template to properly nested YAML format"""
import re
from pathlib import Path

SRC = Path(r"E:\Qahse.Clear\demo\SimWind\Qahse_SimWind_Batch_IEC61400_3_1_NREL5MW.qwd")
DST = Path(r"D:/SimWind_YamlTest\IEC3_1_template.yml")
...
yml_out = ["Qahse:", "  SimWind:"] + children
